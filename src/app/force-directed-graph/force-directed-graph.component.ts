...
export class ForceDirectedGraphComponent implements OnInit {
	...
	runtime = new Runtime();
	main = setTimeout(() => { // Attente (choisie au pif) de la création du DOM avant l'injection du graph
		this.runtime.module(define, Inspector.into(document.getElementById('directedGraph')));
	}, 500);
...
export default function define(runtime, observer){
	...
	main.variable(observer()).define(
		["md"], function(md){
			return(md`# Graphique dirigé par force avec contours convexes`)
		}
	);
